...
Hacer t-test en ambas columnas de probabilidades condicionadas para comprobar que son metodos iguales
```{r}
...
geom_line(aes(y= indepent_prob,colour="independent")) + geom_point(y=combinations_plot$indepent_prob,colour="#7CAE00") +
...
scale_color_manual(values = c("#F8766D","#7CAE00","#00BFC4"), labels = c("Condicionadas","Individuales", "Simulación")) + 
